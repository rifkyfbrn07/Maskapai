...
<div class="max-w-xl mx-auto py-4">
    <div class="mb-8 pb-6 border-b border-slate-900">
        ...
        <h1 class="text-3xl font-extrabold text-white font-display">Add New Airline</h1>
        <p class="text-sm text-slate-400 mt-1">Register a new airline brand operating in Indonesia</p>
    </div>

    <div class="glass-card rounded-2xl p-6 border border-slate-900 relative overflow-hidden">
        <form action="{{ route('airlines.store') }}" method="POST" class="space-y-5">
            @csrf
